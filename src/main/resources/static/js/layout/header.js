...
function updateAlarmList(alarmList, userId) {
    ...
    if (alarmList.length === 0) {
        ...
        alarmList.forEach(alarm => {
            ...
            alarmItem.onclick = () => handleAlarmClick(alarm, userId);
...
function handleAlarmClick(alarm, userId) {
    markAsRead(alarm.alarmId, userId);
...
function markAsRead(alarmId, userId) {
